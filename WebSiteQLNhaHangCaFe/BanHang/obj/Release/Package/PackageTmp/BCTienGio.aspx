<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BCTienGio.aspx.cs" Inherits="BanHang.BCTienGio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Báo cáo tiền giờ" ColCount="4" HorizontalAlign="Center">
                <Items>
