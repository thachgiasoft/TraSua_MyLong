<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BKNhapHang.aspx.cs" Inherits="BanHang.BKNhapHang" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Bảng kê nhập hàng" ColCount="4" HorizontalAlign="Center">
                <Items>
    ...
    <dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" 
         ...
         Height="600px" FooterText="Thông tin nhập hàng"
