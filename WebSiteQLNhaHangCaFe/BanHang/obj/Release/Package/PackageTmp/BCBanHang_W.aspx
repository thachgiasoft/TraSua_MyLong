<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BCBanHang_W.aspx.cs" Inherits="BanHang.BCBanHang_W" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Báo cáo bán hàng" ColCount="4" HorizontalAlign="Center">
                <Items>
