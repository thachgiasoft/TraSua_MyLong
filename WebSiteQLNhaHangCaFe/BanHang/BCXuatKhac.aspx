<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BCXuatKhac.aspx.cs" Inherits="BanHang.BCXuatKhac" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Phiếu xuất khác" ColCount="4" HorizontalAlign="Center">
                <Items>
