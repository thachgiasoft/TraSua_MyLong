...
namespace BanHang
{
    public partial class BKXuatNhapChiTiet : System.Web.UI.Page
    {
        ...
        protected void btnXem_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/BKXuatNhapChiTiet_In.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT + "&IDHangHoa=" + cmbHangHoa.Value;
